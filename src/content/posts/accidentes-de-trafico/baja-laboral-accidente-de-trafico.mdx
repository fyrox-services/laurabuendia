...
<table>
  <thead>
    <tr>
      <th>Tipo de perjuicio</th>
      <th>Cuándo aplica</th>
      <th>Importe/día (2026)</th>
    </tr>
  </thead>
  <tbody>
    <tr>
      <td><span style="display:inline-block;width:10px;height:10px;border-radius:50%;background:#e53e3e;margin-right:8px;vertical-align:middle;"></span><strong>Muy grave</strong></td>
      <td>Ingreso en UCI</td>
      <td><strong>~130,69 €</strong></td>
    </tr>
    <tr>
      <td><span style="display:inline-block;width:10px;height:10px;border-radius:50%;background:#dd6b20;margin-right:8px;vertical-align:middle;"></span><strong>Grave</strong></td>
      <td>Hospitalización o pérdida severa de autonomía</td>
      <td><strong>~98,02 €</strong></td>
    </tr>
    <tr>
      <td><span style="display:inline-block;width:10px;height:10px;border-radius:50%;background:#0593a2;margin-right:8px;vertical-align:middle;"></span><strong>Moderado</strong></td>
      <td>Baja laboral o limitaciones importantes en el día a día</td>
      <td><strong>~67,96 €</strong></td>
    </tr>
    <tr>
      <td><span style="display:inline-block;width:10px;height:10px;border-radius:50%;background:#38a169;margin-right:8px;vertical-align:middle;"></span><strong>Básico</strong></td>
      <td>Lesiones sin baja, con molestias leves</td>
