...
En el contexto del baremo de tráfico, la indemnización por lesiones temporales cubre el periodo desde el accidente hasta la **estabilización lesional**, es decir, hasta que las lesiones se consolidan y se puede valorar si han quedado secuelas. Ese periodo puede ser de semanas o de años, dependiendo de la gravedad.
